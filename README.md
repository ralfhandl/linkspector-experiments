...
Experiments with [Linkspector](https://github.com/UmbrellaDocs/linkspector) v0.5.3.

Linkspector complains about correct links if there are more than 10 links to the same resource that differ only in their anchor values.
